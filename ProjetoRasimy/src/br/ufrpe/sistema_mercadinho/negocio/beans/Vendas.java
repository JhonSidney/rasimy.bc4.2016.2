...
public class Vendas {
	...
	public boolean cupomFiscal(Vendas cupomFiscal){
		boolean igual = false;
		if(cupomFiscal != null && codigoVenda.equals(cupomFiscal.getCodigoVenda()) && this.dataVenda == cupomFiscal.getDataVenda()){
			return true; 
		}
		return igual;
	}
